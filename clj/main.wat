(module
 ...
 (func $main_1 (param $0 i32) (param $1 i32) (param $2 i32) (result i32)
  ...
  (block $do_7 (result i32)
   ...
   (block $do_body_result_6 (result i32)
    (local.set $7
 ...
 ;; custom section "data_size", size 3, contents: "224"
